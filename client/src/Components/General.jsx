...
export const General = ({onLogIn, onNext, onFormDataChange, formData }) => {
//   return (
...
//         <input type="text" name="username" value={formData.username} onChange={onFormDataChange}  className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
...
//         </label>
//         <div className="mt-2">
//         <input type="number" name="age" value={formData.age} onChange={onFormDataChange}    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
//                     placeholder="2"
//  />
//   </div>
//               {/* </div> */}
...
//                   autoComplete="gender"
//                   className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
//                   value={formData.gender} onChange={onFormDataChange}                
//                 >
...
<section className="bg-white">
  <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
    <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
      <img
        alt=""
        src="/ivf-clinic-in-philippines-626x482.jpg"
        ...
        <form action="#" className="mt-8 grid grid-cols-6 gap-6">
          ...
          <div className="col-span-6">
            ...
            <input
              ...
              name="username"
              className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
              value={formData.username} onChange={onFormDataChange}
            />
          </div>
          <div className="col-span-6">
          ...
          <div className="col-span-6 sm:col-span-3">
            ...
            <input
              ...
              name="age"
              className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
            value={formData.age} onChange={onFormDataChange}
            />
          </div>
          ...
          <div className="col-span-6 sm:col-span-3">
            ...
            <input
              ...
              name="password"
              className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
              value={formData.password} onChange={onFormDataChange}
            />
          </div>
